...
struct UGameplayTask : UObject {
	...
	void ReadyForActivation(); // Function GameplayTasks.GameplayTask.ReadyForActivation // (Final|Native|Public|BlueprintCallable) // Param Size : 0x0, 0x7FF65594E2A0
	void GenericGameplayTaskDelegate__DelegateSignature(); // DelegateFunction GameplayTasks.GameplayTask.GenericGameplayTaskDelegate__DelegateSignature // (MulticastDelegate|Public|Delegate) // Param Size : 0x0, 0x7FF653FAFDF0
	void EndTask(); // Function GameplayTasks.GameplayTask.EndTask // (Final|Native|Public|BlueprintCallable) // Param Size : 0x0, 0x7FF65594DF50
};
...
struct UGameplayTask_ClaimResource : UGameplayTask {
	...
	struct UGameplayTask_ClaimResource* ClaimResources(struct TScriptInterface<None> InTaskOwner, struct TArray<class UGameplayTaskResource*> ResourceClasses, enum class None Priority, struct FName TaskInstanceName); // Function GameplayTasks.GameplayTask_ClaimResource.ClaimResources // (Final|Native|Static|Public|BlueprintCallable) // Param Size : 0x38, 0x7FF65594DDB0
	struct UGameplayTask_ClaimResource* ClaimResource(struct TScriptInterface<None> InTaskOwner, class UGameplayTaskResource* ResourceClass, enum class None Priority, struct FName TaskInstanceName); // Function GameplayTasks.GameplayTask_ClaimResource.ClaimResource // (Final|Native|Static|Public|BlueprintCallable) // Param Size : 0x30, 0x7FF65594DC60
};
...
struct UGameplayTask_SpawnActor : UGameplayTask {
	...
	struct UGameplayTask_SpawnActor* SpawnActor(struct TScriptInterface<None> TaskOwner, struct FVector SpawnLocation, struct FRotator SpawnRotation, class AActor* Class, bool bSpawnOnlyOnAuthority); // Function GameplayTasks.GameplayTask_SpawnActor.SpawnActor // (Final|Native|Static|Public|HasDefaults|BlueprintCallable) // Param Size : 0x40, 0x7FF65594E2C0
	void FinishSpawningActor(struct UObject* WorldContextObject, struct AActor* SpawnedActor); // Function GameplayTasks.GameplayTask_SpawnActor.FinishSpawningActor // (Native|Public|BlueprintCallable) // Param Size : 0x10, 0x7FF65594DF70
	bool BeginSpawningActor(struct UObject* WorldContextObject, struct AActor* SpawnedActor); // Function GameplayTasks.GameplayTask_SpawnActor.BeginSpawningActor // (Native|Public|HasOutParms|BlueprintCallable) // Param Size : 0x11, 0x7FF65594DB80
};
...
struct UGameplayTask_WaitDelay : UGameplayTask {
	...
	struct UGameplayTask_WaitDelay* TaskWaitDelay(struct TScriptInterface<None> TaskOwner, float Time, enum class None Priority); // Function GameplayTasks.GameplayTask_WaitDelay.TaskWaitDelay // (Final|Native|Static|Public|BlueprintCallable) // Param Size : 0x20, 0x7FF65594E470
	void TaskDelayDelegate__DelegateSignature(); // DelegateFunction GameplayTasks.GameplayTask_WaitDelay.TaskDelayDelegate__DelegateSignature // (MulticastDelegate|Public|Delegate) // Param Size : 0x0, 0x7FF653FAFDF0
};
...
struct UGameplayTasksComponent : UActorComponent {
	...
	void OnRep_SimulatedTasks(); // Function GameplayTasks.GameplayTasksComponent.OnRep_SimulatedTasks // (Final|Native|Public) // Param Size : 0x0, 0x7FF65594E280
	enum class EGameplayTaskRunResult K2_RunGameplayTask(struct TScriptInterface<None> TaskOwner, struct UGameplayTask* Task, enum class None Priority, struct TArray<class UGameplayTaskResource*> AdditionalRequiredResources, struct TArray<class UGameplayTaskResource*> AdditionalClaimedResources); // Function GameplayTasks.GameplayTasksComponent.K2_RunGameplayTask // (Final|Native|Static|Public|BlueprintCallable) // Param Size : 0x41, 0x7FF65594E040
};
