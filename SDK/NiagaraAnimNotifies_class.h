...
struct UAnimNotify_PlayNiagaraEffect : UAnimNotify {
	...
	struct UFXSystemComponent* GetSpawnedEffect(); // Function NiagaraAnimNotifies.AnimNotify_PlayNiagaraEffect.GetSpawnedEffect // (Final|Native|Public|BlueprintCallable|Const) // Param Size : 0x8, 0x7FF65334AE10
};
