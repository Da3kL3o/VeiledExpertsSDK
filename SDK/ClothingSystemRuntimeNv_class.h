...
struct UClothingSimulationInteractorNv : UClothingSimulationInteractor {
	...
	void SetAnimDriveDamperStiffness(float InStiffness); // Function ClothingSystemRuntimeNv.ClothingSimulationInteractorNv.SetAnimDriveDamperStiffness // (Final|Native|Public|BlueprintCallable) // Param Size : 0x4, 0x7FF655830070
};
